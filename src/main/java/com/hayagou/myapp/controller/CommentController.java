...
public class CommentController {
    ...
    @PostMapping("/{postId}")
    public CommonResult comment(@PathVariable long postId, @Valid @ModelAttribute CommentRequestDto commentRequestDto) {
    ...
    @GetMapping("/{postId}")
    public ListResult<CommentResponseDto> getComments(@PathVariable long postId, @ApiParam(value = "페이지", defaultValue = "1")@RequestParam int page) {
