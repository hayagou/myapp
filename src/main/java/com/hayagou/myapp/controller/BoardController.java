...
//    @ApiOperation(value = "게시판 목록 조회", notes = "게시판 목록을 조회한다.")
//    @GetMapping
//    public ListResponse<BoardDto> boards(@ApiParam(value = "페이지", defaultValue = "1")@RequestParam int page) {
//        return responseService.getListResult(boardService.getBoardList(page));
//    }
//
//    @ApiImplicitParams({
...
//    @PostMapping
//    public DataResponse<Long> board(@Valid @ModelAttribute BoardDto boardDto) {
...
//    @DeleteMapping
//    public CommonResponse deleteBoard(@Valid @ModelAttribute BoardDto boardDto) {
